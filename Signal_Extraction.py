...
def vector_to_timestamps(vec, audio, sr, path):
    """
    """
    ...
    try:
        ...
        print(f'Nr. of starts and stops doesnt match for file {path}') # Technically impossible but I'm superstitious
...
def signal_timestamps(path):
    ...
    timestamps, sum_signal = vector_to_timestamps(vec, audio, sr, path)
    duration = audio.shape[0] / sr
    return duration, sum_signal, timestamps

  
""" Test run:
path = 'Test Birdsounds/anser%20brachyrhynchus46.mp3'

d, s, t = signal_timestamps(path)
"""
